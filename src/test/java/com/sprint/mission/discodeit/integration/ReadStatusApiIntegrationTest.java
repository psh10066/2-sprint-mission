...
class ReadStatusApiIntegrationTest extends AbstractContainerBaseTest {
    ...
    void createReadStatus_Success() throws Exception {
        ...
        ChannelDto channel = channelService.createPublic(channelRequest);
    ...
    void findAllReadStatusesByUserId_Success() throws Exception {
        ...
        ChannelDto channel1 = channelService.createPublic(channelRequest1);
        ChannelDto channel2 = channelService.createPublic(channelRequest2);
